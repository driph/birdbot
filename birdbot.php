...
if($token != 'MJnfEefdV0xHzzKzS8swemQn'){ #replace this with the token from your slash command configuration page
...
$user_agent = "BirdBot/0.1 (https://github.com/driph/birdbot; chris@driph.com)";
...
$url_to_check = "http://birdfact.driph.com/";
# Set up cURL 
...
#	the following changes this JSON string...
#
#	{
...
# here's where we build the reply:



if ($text == "help") {
	$reply = "This is where help happens.";
	}

else {
	$reply = json_encode(array(
                "content-type"  =>  "application/json",
                "text"          =>  $response_array["fact"],
